				...
				<CardContent className="flex flex-col space-y-2">
					<div>
						...
						<p className="text-sm text-muted-foreground">
							...
							description, options, NOT response)
						</p>
					</div>
					<div>
						...
						<p className="text-sm text-muted-foreground">
							...
							Discord. It will not remove your commands' blocks,
							but you will not be able to use your commands on
							Discord anymore until you sync again. Useful when
