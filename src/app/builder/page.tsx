...
import { ReactFlow, useNodesState, useEdgesState, addEdge, Background, BackgroundVariant, ReactFlowProvider } from "@xyflow/react"
...
function Builder()  {
    ...
    return (
        <div className="w-[100vw] h-[100vh]">
            ...
            <Background variant={BackgroundVariant.Dots} gap={18} size={2} color="#525252" />
            <Button>Save</Button>
        </div>
    )
}